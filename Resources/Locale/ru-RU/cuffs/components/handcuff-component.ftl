...
handcuff-component-start-cuffing-self-observer = {$user} начинает надевать наручники на {REFLEXIVE($target)}.
handcuff-component-cuff-self-observer-success-message = {$user} надел наручники на {REFLEXIVE($target)}.
