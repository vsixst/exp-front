...
command-description-stationevent-lsprobtheoretical = Для данного прототипа BasicStationEventScheduler с указанием количества игроков и времени раунда отображает вероятность различных станционных событий.
command-description-tag-with = Возвращает только объекты с заданным тегом из переданного списка.
command-description-xenoartifact-list = Перечислить все EntityUids созданных артефактов.
command-description-xenoartifact-printMatrix = Выводит матрицу, отображающую все соединения между узлами.
command-description-xenoartifact-totalResearch = Показывает всё количество очков исследования, которое можно извлечь из текущего артефакта.
command-description-xenoartifact-averageResearch = Рассчитывает среднее количество очков исследования, генерируемое артефактом при полной активации.
