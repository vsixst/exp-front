...
id-card-console-window-ship-name-label = Шаттл:
...
id-card-console-window-shuttle-placeholder = Нет привязанного шаттла
...
id-card-console-damaged = Целостность структуры нарушена, извлечение содержимого.
