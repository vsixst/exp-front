...
ent-BannerScrapTech = Знамя Scrap Tech
    .desc = Знамя, изображающее символику какой-то паршивой компании. Все знамя в грязи и моторном масле, а в углу можно заметить плохо-зачеркнутую символику другой компании.
