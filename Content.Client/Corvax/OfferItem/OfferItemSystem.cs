...
using Content.Shared.Corvax.OfferItem;
...
namespace Content.Client.Corvax.OfferItem;
...
public sealed class OfferItemSystem : SharedOfferItemSystem
{
    ...
    {
        base.Initialize();
        Subs.CVar(_cfg, CorvaxVars.OfferModeIndicatorsPointShow, OnShowOfferIndicatorsChanged, true);
    }
